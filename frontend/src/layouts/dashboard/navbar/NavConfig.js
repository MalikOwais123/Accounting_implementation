...
const navConfig = [
  ...
  // ----------------------------------------------------------------------
  {
    ...
    items: [
      ...
      { title: 'adjusted trial balance', path: PATH_DASHBOARD.general.adjsutedTrialBalance, icon: ICONIFYICONS.trialBalance },
    ...
    items: [
      // MANAGEMENT : ACCOUTNS
      {
        ...
        children: [
          ...
          { title: 'create', path: PATH_DASHBOARD.accounts.new },
